/* esri-leaflet-geocoder - v2.2.14 - Mon Mar 11 2019 11:22:03 GMT-0700 (Pacific Daylight Time)
...
!function(e, t) {
    ...
    var g = "https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/",
        p = s.Task.extend({
            ...
            _processGeocoderResponse: function(e) {
                for (var i = [], o = 0; o < e.candidates.length; o++) {
                    ...
                    if (r.extent)
                        var n = s.Util.extentToBounds(r.extent);
                    i.push({
                        text: r.address,
                        bounds: n,
                        score: r.score,
        ...
        v = s.Task.extend({
            ...
            initialize: function(e) {
                e = e || {},
                e.url || (e.url = g, e.supportsSuggest = !0),
                    s.Task.prototype.initialize.call(this, e)
            },
            within: function(e) {
                e = t.latLngBounds(e),
        ...
        m = s.Service.extend({
            initialize: function(e) {
                e = e || {},
                    e.url ? (s.Service.prototype.initialize.call(this, e), this._confirmSuggestSupport()) : (e.url = g, e.supportsSuggest = !0, s.Service.prototype.initialize.call(this, e))
            },
            geocode: function() {
                return i(this)
            },
        ...
        _ = t.Evented.extend({
            ...
            initialize: function(e, s) {
                if (t.Util.setOptions(this, s), this._control = e, !s || !s.providers || !s.providers.length)
            ...
            _geocode: function(e, s, i) {
                var o,
                    ...
                    a = t.Util.bind(function(t, s) {
                        r--,
                        t || (s && (n = n.concat(s)), r <= 0 && (o = this._boundsFromResults(n), this.fire("results", {
                            results: n,
                            bounds: o,
                ...
                if (s)
                    r++,
                        i.results(e, s, this._searchBounds(), a);
                else
                    for (var l = 0; l < this._providers.length; l++)
                        r++,
                            this._providers[l].results(e, s, this._searchBounds(), a)
            },
            _suggest: function(e) {
                    ...
                    i = t.Util.bind(function(e, i) {
                        return t.Util.bind(function(t, o) {
                            if (!t) {
                                var r;
                                if (s -= 1, e.length < 2)
                                    return this._suggestions.innerHTML = "", void (this._suggestions.style.display = "none");
                                if (o.length)
                                    for (r = 0; r < o.length; r++)
                                        o[r].provider = i;
                                else
                                    this._control._renderSuggestions(o);
                                if (i._lastRender !== e && i.nodes) {
                                    for (r = 0; r < i.nodes.length; r++)
                                        i.nodes[r].parentElement && this._control._suggestions.removeChild(i.nodes[r]);
                                    i.nodes = []
                                }
        ...
        x = t.Control.extend({
            ...
            initialize: function(e) {
                ...
                this._geosearchCore._pendingSuggestions = [],
                    t.Control.prototype.initialize.call(e)
            },
            _renderSuggestions: function(e) {
                ...
                for (var i, o, r = [], n = [], a = 0; a < e.length; a++) {
                    ...
                    if (!o && this._geosearchCore._providers.length > 1 && s !== l.provider.options.label && (o = t.DomUtil.create("span", "geocoder-control-header", this._suggestions), o.textContent = l.provider.options.label, o.innerText = l.provider.options.label, s = l.provider.options.label, r.push(o)), i || (i = t.DomUtil.create("ul", "geocoder-control-list", this._suggestions)), -1 === n.indexOf(l.text)) {
                        ...
                        u.innerHTML = l.text,
                            u.provider = l.provider,
                            u["data-magic-key"] = l.magicKey,
                            u.unformattedText = l.unformattedText
                    } else
                        for (var d = 0; d < i.childNodes.length; d++)
                            i.childNodes[d].innerHTML === l.text && (i.childNodes[d]["data-magic-key"] += "," + l.magicKey);
                    n.push(l.text)
                }
            ...
            clear: function() {
                ...
                this.options.collapseAfterResult && (this._input.value = "", this._input.placeholder = "", t.DomUtil.removeClass(this._wrapper, "geocoder-control-expanded")),
            ...
            clearSuggestions: function() {
                if (this._nodes)
                    for (var e = 0; e < this._nodes.length; e++)
                        this._nodes[e].parentElement && this._suggestions.removeChild(this._nodes[e])
            },
                ...
                return e.attributionControl && e.attributionControl.addAttribution(i), t.DomEvent.addListener(this._input, "focus", function(e) {
                    ...
                    switch (e.keyCode) {
                        ...
                        case 38:
                            ...
                            var a = o[i - 1];
                            r && a ? t.DomUtil.addClass(a, "geocoder-control-selected") : t.DomUtil.addClass(o[o.length - 1], "geocoder-control-selected"),
                                t.DomEvent.preventDefault(e);
                            break;
                        case 40:
                            r && t.DomUtil.removeClass(r, "geocoder-control-selected");
                            var l = o[i + 1];
                            r && l ? t.DomUtil.addClass(l, "geocoder-control-selected") : t.DomUtil.addClass(o[0], "geocoder-control-selected"),
                                t.DomEvent.preventDefault(e);
                            break;
                        default:
        ...
        C = s.MapService.extend({
            ...
            results: function(e, t, s, i) {
                ...
                if (t) {
                    ...
                    o = this.find().text(e).fields(this.options.searchFields).layers(this.options.layers);
    ...
    e.VERSION = "2.2.14",
        ...
        e.featureLayerProvider = d,
        e.MapServiceProvider = C,
        e.mapServiceProvider = h,
        e.GeocodeServiceProvider = S,
